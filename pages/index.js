...
export default function Home() {
          ...
          <div className="mx-auto max-w-screen-2xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            <div className="sm:flex sm:items-center sm:justify-between">
              <div className="text-center sm:text-left">
                <h1 className="text-3xl font-bold text-gray-900 sm:text-3xl">Welcome Back, <span className="text-green-800">{session.user.name}!</span></h1>
  ...
  return (
    <div className="flex flex-col justify-center m-auto items-center min-h-screen bg-white w-screen">
      <h1 className="text-4xl font-bold max-w-lg text-center text-black">
        Welcome to admin of the website
      </h1>
      <p className="font-medium my-4 text-black">
