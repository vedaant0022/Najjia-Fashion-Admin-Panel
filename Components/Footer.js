...
export default function Footer() {
  return (
<footer className="bg-white w-screen h">
  <div className="mx-auto  px-4 py-16 sm:px-6 lg:px-8 pt-96 ">
    ...
    <div className="mt-8 border-t border-gray-100 pt-8">
      <div className="sm:flex sm:justify-between">
        <p className="text-xs text-gray-500">&copy; 2022. VisionX Technologies. All rights reserved.</p>
